...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Package.slug'
        db.add_column('dropcamp_package', 'slug', self.gf('django.db.models.fields.SlugField')(default='a', max_length=40, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Package.slug'
        db.delete_column('dropcamp_package', 'slug')
